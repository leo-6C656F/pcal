  ...
  return (
    <div className="max-w-2xl mx-auto py-12 px-6">
      ...
      <div className="space-y-6 mb-12">
        <div className="flex gap-6 items-start p-6 bg-white rounded-2xl border-2 border-slate-200 hover:border-blue-300 hover:shadow-lg transition-all">
      ...
      <div className="bg-blue-50 border-2 border-blue-100 rounded-2xl p-6 mb-8">
        <h3 className="font-semibold text-blue-900 mb-3">✓ {t('welcome.goodToKnow')}</h3>
      ...
      <button
        ...
        className="w-full btn-primary py-4 text-lg shadow-lg shadow-blue-200 hover:shadow-xl"
      >
